...
exec_sql()
{
   ...
   . /amb/eventbin/SQL_RUN.PROC3 "${TWO_TASK}" "${USRPASS}" "${SQL} ${SITE} ${CICLO} ${DATA}" "${EMAIL}" "${DESC}" 0 ARPU_SQL_03 "${SPOOL}"
