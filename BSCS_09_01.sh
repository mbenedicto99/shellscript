#!/bin/ksh
	...
	# Finalidade    : CHG5922 - Relatorio/Correcao de contratos com pendencias. REPROCESSAMENTO DO REQUEST.
	# Input         : BSCS_09_01.sh
	# Output        : mail, log
...
DESC="${COD} - Relatorio de contratos com pendencias. REPROCESSAMENTO DO REQUEST."
