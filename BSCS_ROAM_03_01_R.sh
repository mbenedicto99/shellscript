#!/bin/ksh 
#   Programa: BSCS_ROAM_03_01_R.sh - Reenvia os arquivos a Connect Enterprise - SPOAXIS1
#
#   Data: 22/05/2000
#   Renato/Reginaldo
#
...
#
#   Obs.: Somente eh carregado no Control-M em caso de falha no BSCS_ROAM_03_01.sh.
#
## Mensagens
