...
# ------------------------------------------------
DEST=roaming@unix_mail_fwd
DEST2=roaming3@unix_mail_fwd
DEST3=roaming4@unix_mail_fwd
...
/amb/operator/bin/attach_mail $DEST $LOG "TAPOUT Report $SITE - $DATA"

# Envio de e-mail do relatorio de Minutagem de Romeiros:
/amb/operator/bin/attach_mail $DEST2 $REL "Minutagem de Romeiros $SITE - $DATA"

# Envio de e-mail do Relatorio de Chamadas MOC em Roaming Intl do TAPOUT:
/amb/operator/bin/attach_mail $DEST3 $REL_MOC "Chamadas MOC em Roaming Internacional $SITE - $DATA"

# Copia dos relatorios para geracao de controles do Revenue Assurance:
# ALterado em 2003/08/26 - Edison Santos (Workmation) - Consolidacao MIBAS - BSCS
#===================================================================================#
### cp $LOG /abscs_sp/sched/mach/.
### cp $REL_MOC /abscs_sp/sched/mach/.
### cp $REL /abscs_sp/sched/mach/rel_tapout_${TS}.txt
